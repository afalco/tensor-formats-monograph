...
(Definition~\ref{def:tucker_rank}): $r_\alpha(\rho)$ is the dimension
...
(Definition~\ref{def:tucker_rank}).
...
(Algorithm~\ref{alg:HOSVD} in Appendix~\ref{app:algorithms}):
