...
\begin{proposition}[{\cite[Proposition~4.2]{FHHM}}]
...
\begin{proposition}[{\cite[Theorem~4.5]{FHHM}}]
...
\begin{lemma}[{\cite[Lemma~2.1]{DRW}}]
...
\textup{(}see~\cite[2.7, 2.8]{Upmeier}\textup{)}.
\end{example}
...
\begin{proposition}[{\cite[Proposition~79]{HJ}}]
...
\begin{proposition}[{\cite[Theorem~160]{HJ}}]
